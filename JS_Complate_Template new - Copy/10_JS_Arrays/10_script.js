...
output = 'Before' + arr1.join();
document.getElementById('display1').innerHTML = output;
var arr2 = arr1.slice();  //create a new copy
...
// indexOf()
arr1 = [10,20,30,40,50];
console.log('Index of 10 is : ' + arr1.indexOf(10));
console.log('Index of 30 is : ' + arr1.indexOf(30));
console.log('Index of 100 is : ' + arr1.indexOf(100));
